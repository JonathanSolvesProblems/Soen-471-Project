...
def range_upvotes(df):
    df = df.withColumn("upvotes", when((col("upvotes") >= 0) & (col("upvotes") <= 5000), 1).when(
        (col("upvotes") > 5000) & (col("upvotes") <= 10000), 2) \
                       .when((col("upvotes") > 10000) & (col("upvotes") <= 15000), 3).when(
        (col("upvotes") > 15000) & (col("upvotes") <= 20000), 4) \
                       .when((col("upvotes") > 20000) & (col("upvotes") <= 25000), 5).when(
        (col("upvotes") > 30000) & (col("upvotes") <= 35000), 6) \
                       .when((col("upvotes") > 35000) & (col("upvotes") <= 40000), 7).when(
        (col("upvotes") > 40000) & (col("upvotes") <= 45000), 8) \
                       .when((col("upvotes") > 45000) & (col("upvotes") <= 50000), 9).when(
        (col("upvotes") > 50000) & (col("upvotes") <= 55000), 10) \
                       .when((col("upvotes") > 55000) & (col("upvotes") <= 60000), 11).when(
        (col("upvotes") > 60000) & (col("upvotes") <= 65000), 12) \
